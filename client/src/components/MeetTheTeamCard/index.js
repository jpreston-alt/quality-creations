  ...
  return (
    <div>
      <div class="uk-card uk-card-default uk-card-body uk-margin-top uk-card-hover">
        ...
        <div
          class="uk-grid-divider uk-child-width-expand@m employee-container"
          uk-grid="true"
        >
          <div>
            <EmployeeCard
              ...
              email="adam@quality-creations.com"
            />
          </div>
          <div>
            <EmployeeCard
              ...
              email="nick@quality-creations.com"
            />
          </div>
          <div>
            <EmployeeCard
              ...
              email="joanna@quality-creations.com"
            />
          </div>
        </div>
      </div>
